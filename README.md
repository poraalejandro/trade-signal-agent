...
`app.py` (the Streamlit UI wrapping the above) is the last piece and isn't built yet. Everything through `backtest.py` — data, indicators, fundamental check, agent, and evaluation harness — is done.

## Stack

Python · [yfinance](https://github.com/ranaroussi/yfinance) · [Groq](https://groq.com/) (`qwen/qwen3.8-27b`) · [Pydantic](https://docs.pydantic.dev/) for structured LLM output · [pandas](https://pandas.pydata.org/) · [Streamlit](https://streamlit.io/) (planned, for `app.py`)
